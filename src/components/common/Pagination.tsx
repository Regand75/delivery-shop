    ...
    <div className="md: mt-10 mb-20 flex justify-center text-base text-sm text-white">
      <nav className="md: flex items-center gap-1 gap-2">
        <Link
          ...
          className={`${buttonSize} ${currentPage === 1 ? buttonDisabled : buttonActive}`}
        >
          &laquo;
        </Link>
        <Link
        ...
        {visiblePages.map((page, index) => {
          if (page === '...') {
            return (
              <span key={`ellipsis-${index}`} className={`${buttonSize} text-[#ff6633]`}>
                ...
              </span>
            );
          }
            ...
            <Link
              ...
              className={`${pageButtonClass} ${
                currentPage === page
                  ...
                  : 'hover:border-transparents bg-white text-[#ff6633] hover:bg-[#ff6633] hover:text-white'
              }`}
            >
              {page}
            </Link>
        ...
        <Link
          ...
          className={`${buttonSize} ${currentPage === totalPages ? buttonDisabled : buttonActive}`}
        >
          &rsaquo;
        </Link>
